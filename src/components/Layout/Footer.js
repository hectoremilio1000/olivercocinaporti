      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="relative w-14 h-14 rounded-full overflow-hidden ring-2 ring-white/20 bg-white flex-shrink-0">
              <Image src="/logo-oliver.jpg" alt={SITE.name} fill sizes="56px" className="object-cover" />
            </div>
            <div>
